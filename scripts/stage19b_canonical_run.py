#!/usr/bin/env python3
"""The 6,000 canonical comparisons under the capacity-extended Algorithm 5 variant.
...
BRIDGE = Path(
    os.environ.get(
        ...
        "/home/nbisbuild/stage19b-openafis/bridge/build/fpbench_openafis_bridge",
    )
)
OUTPUT_ROOT = Path(
    os.environ.get("FPBENCH_STAGE19B_ROOT", "/mnt/c/Users/sirak/.cache/fpbench/private/stage19b")
)

RUN_ID = "run_stage19b_canonical500"
